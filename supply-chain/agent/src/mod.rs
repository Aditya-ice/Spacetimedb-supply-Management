...
pub mod alert_table;
pub mod alert_type;
pub mod assign_driver_to_shipment_reducer;
pub mod create_driver_reducer;
pub mod create_shipment_reducer;
pub mod driver_table;
pub mod lat_long_location_type;
pub mod process_sensor_reading_reducer;
pub mod sensor_reading_table;
pub mod sensor_reading_type;
pub mod shipment_table;
pub mod shipment_type;
pub mod transporter_type;

pub use alert_table::*;
pub use alert_type::Alert;
pub use assign_driver_to_shipment_reducer::{
    assign_driver_to_shipment, set_flags_for_assign_driver_to_shipment,
    AssignDriverToShipmentCallbackId,
};
pub use create_driver_reducer::{
    create_driver, set_flags_for_create_driver, CreateDriverCallbackId,
};
pub use create_shipment_reducer::{
    create_shipment, set_flags_for_create_shipment, CreateShipmentCallbackId,
};
pub use driver_table::*;
pub use lat_long_location_type::LatLongLocation;
pub use process_sensor_reading_reducer::{
    process_sensor_reading, set_flags_for_process_sensor_reading, ProcessSensorReadingCallbackId,
};
pub use sensor_reading_table::*;
pub use sensor_reading_type::SensorReading;
pub use shipment_table::*;
pub use shipment_type::Shipment;
pub use transporter_type::Transporter;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AssignDriverToShipment { .. } => "assign_driver_to_shipment",
            Reducer::CreateDriver { .. } => "create_driver",
            Reducer::CreateShipment { .. } => "create_shipment",
            Reducer::ProcessSensorReading { .. } => "process_sensor_reading",
        }
    }
}
        ...
        match &value.reducer_name[..] {
            "assign_driver_to_shipment" => {
                Ok(__sdk::parse_reducer_args::<
                    assign_driver_to_shipment_reducer::AssignDriverToShipmentArgs,
                >("assign_driver_to_shipment", &value.args)?
                .into())
            }
            "create_driver" => Ok(__sdk::parse_reducer_args::<
                create_driver_reducer::CreateDriverArgs,
            >("create_driver", &value.args)?
            .into()),
            "create_shipment" => Ok(__sdk::parse_reducer_args::<
                create_shipment_reducer::CreateShipmentArgs,
            >("create_shipment", &value.args)?
            .into()),
            "process_sensor_reading" => Ok(__sdk::parse_reducer_args::<
                process_sensor_reading_reducer::ProcessSensorReadingArgs,
            >("process_sensor_reading", &value.args)?
            .into()),
            unknown => {
                Err(
...
#[doc(hidden)]
pub struct DbUpdate {
    alert: __sdk::TableUpdate<Alert>,
    driver: __sdk::TableUpdate<Transporter>,
    sensor_reading: __sdk::TableUpdate<SensorReading>,
    shipment: __sdk::TableUpdate<Shipment>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "alert" => db_update
                    .alert
                    .append(alert_table::parse_table_update(table_update)?),
                "driver" => db_update
                    .driver
                    .append(driver_table::parse_table_update(table_update)?),
                "sensor_reading" => db_update
                    .sensor_reading
                    .append(sensor_reading_table::parse_table_update(table_update)?),
                "shipment" => db_update
                    .shipment
                    .append(shipment_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.alert = cache
            .apply_diff_to_table::<Alert>("alert", &self.alert)
            .with_updates_by_pk(|row| &row.id);
        diff.driver = cache
            .apply_diff_to_table::<Transporter>("driver", &self.driver)
            .with_updates_by_pk(|row| &row.id);
        diff.sensor_reading = cache
            .apply_diff_to_table::<SensorReading>("sensor_reading", &self.sensor_reading)
            .with_updates_by_pk(|row| &row.id);
        diff.shipment = cache
            .apply_diff_to_table::<Shipment>("shipment", &self.shipment)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    alert: __sdk::TableAppliedDiff<'r, Alert>,
    driver: __sdk::TableAppliedDiff<'r, Transporter>,
    sensor_reading: __sdk::TableAppliedDiff<'r, SensorReading>,
    shipment: __sdk::TableAppliedDiff<'r, Shipment>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Alert>("alert", &self.alert, event);
        callbacks.invoke_table_row_callbacks::<Transporter>("driver", &self.driver, event);
        callbacks.invoke_table_row_callbacks::<SensorReading>(
            "sensor_reading",
            &self.sensor_reading,
            event,
        );
        callbacks.invoke_table_row_callbacks::<Shipment>("shipment", &self.shipment, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        alert_table::register_table(client_cache);
        driver_table::register_table(client_cache);
        sensor_reading_table::register_table(client_cache);
        shipment_table::register_table(client_cache);
    }
}
